...
import bushes from "../assets/ap-women-conversation.png";
...
const HomePageThree = () => {
  return (
    <section className="w-full   h-full">
      ...
      <div
        className="relative bg-[#5a9e7c] bg-opacity-50 h-screen lg:h-[50%] xl:h-screen lg:pt-40 xl:pt-0 bg-cover bg-center flex flex-col lg:flex-row lg: justify-between items-center pt-20 md:mt-0"
      ...
      >
        ...
        <div className="relative   z-10  flex flex-col justify-center w-full lg:w-[90%] mx-auto h-full px-6 lg:px-24 text-left">
          <div className="w-full lg:max-w-2xl text-bg-[#5a9e7c]">
            <p className="text-xs sm:text-sm mb-2 uppercase tracking-wide bg-[#5a9e7c] bg-opacity-65 font-bold px-3 py-2 rounded-xl inline-block">
            ...
            <p className="text-lg font-bold sm:text-lg lg:text-base w-full sm:w-[90%] leading-6 sm:leading-7 mb-6 sm:Pb-8">
             The good life is a process, not a state of being. It is a direction, not a destination
             <br/>
                 — CARL ROGERS
            </p>
            <button className="bg-[#5a9e7c] text-white px-6 py-2 rounded-full hover:bg-green-700 transition duration-300 mb-5">
              Our Services
            </button>
          </div>
        </div>
