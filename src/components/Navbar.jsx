...
const Navbar = () => {
  ...
  const serviceDropdownItems = [
    ...
    { label: "Service Style 2", path: "/ServicesTwo" },
    { label: "Service Style 3", path: "/ServicesThree" },
    { label: "Service Single", path: "/ServicesSingle" },
    ...
    >
      <div className="w-[95%] lg:w-full xl:w-[80%] mx-auto flex justify-between items-center">
        ...
        <nav className={`hidden lg:flex space-x-6`}>
          ...
          >
            <NavLink to={"/aboutus"} className="text-sm font-semibold">About Us</NavLink>
            <NavLink to={"/Studycase"} className="text-sm font-semibold">Study Case</NavLink>
        ...
        <div className="hidden lg:flex items-center space-x-4">
          <div className="flex items-center space-x-1">
            <MdHeadsetMic className=" lg:text-3xl xl:text-5xl text-[#83cc61]" />
            <div
          ...
          <NavLink className="bg-green-500 text-sm  text-white px-6 py-3 rounded-full hover:bg-green-600">
            Make Appointment
          </NavLink>
        </div>
